...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ST_ST25R_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ST25R, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ST25R3916B, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RFAL_FEATURE_NFCA, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RFAL_FEATURE_ISO_DEP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RFAL_FEATURE_ISO_DEP_POLL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RFAL_FEATURE_ISO_DEP_IBLOCK_MAX_LEN, 256);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RFAL_FEATURE_NFC_DEP_BLOCK_MAX_LEN, 254);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RFAL_FEATURE_NFC_RF_BUF_LEN, 258);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RFAL_FEATURE_ISO_DEP_APDU_MAX_LEN, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RFAL_FEATURE_NFC_DEP_PDU_MAX_LEN, 512);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ST25R_TRIGGER_GLOBAL_THREAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ZEPHYR_ST25R_MODULE, 1);
